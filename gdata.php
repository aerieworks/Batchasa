<?
$picasaUrlBase = 'https://picasaweb.google.com/data/';
$picasaFeedUrlBase = $picasaUrlBase . 'feed/api/';
$picasaEntryUrlBase = $picasaUrlBase . 'entry/api/';


if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    $url = $picasaFeedUrlBase . $_GET['feed'];
    
    $request = new HttpRequest($url, HttpRequest::METH_GET);
    $request->addHeaders(array('GData-Version' => '2'));
    $request->addQueryData(array(
        'alt' => 'json',
        'oauth_token' => $_GET['authToken']));
    $request->send();
